...
class StadiaControllerTest < ActionController::TestCase
  ...
  test "should create stadium" do
    assert_difference('Stadium.count') do
      post :create, stadium: { capacity: @stadium.capacity, foundation: @stadium.foundation, name: @stadium.name, nickname: @stadium.nickname, picture: @stadium.picture }
    end
  ...
  test "should update stadium" do
    patch :update, id: @stadium, stadium: { capacity: @stadium.capacity, foundation: @stadium.foundation, name: @stadium.name, nickname: @stadium.nickname, picture: @stadium.picture }
    assert_redirected_to stadium_path(assigns(:stadium))
  end
