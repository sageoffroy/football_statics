...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { binding_key: @stat.binding_key, description: @stat.description }
    end
  ...
  test "should update stat" do
    patch :update, id: @stat, stat: { binding_key: @stat.binding_key, description: @stat.description }
    assert_redirected_to stat_path(assigns(:stat))
  end
